...
export default function Edit({ trail }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('admin.trails.update', trail.id));
    };

    return (
        <AdminLayout>
            <Head title="Admin - Editar Trilha" />

            <div className="p-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-black mb-2 text-white italic">EDITAR TRILHA</h1>
                    <p className="text-zinc-500">Atualize os dados da trilha.</p>
                </div>
