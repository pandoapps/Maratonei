...
export default function Edit({ expert }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('admin.experts.update', expert.id));
    };

    return (
        <AdminLayout>
            <Head title="Admin - Editar Expert" />

            <div className="p-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-black mb-2 text-white italic">EDITAR EXPERT</h1>
                    <p className="text-zinc-500">Atualize os dados do expert.</p>
                </div>
