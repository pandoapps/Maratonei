...
export default function Create() {
    ...
    return (
        <AdminLayout>
            <Head title="Admin - Nova Categoria" />

            <div className="p-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-black mb-2 text-white italic">NOVA CATEGORIA</h1>
                    <p className="text-zinc-500">Preencha os dados da nova categoria.</p>
                </div>
