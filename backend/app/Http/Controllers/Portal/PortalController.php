...
class PortalController extends Controller
{
    ...
    {
        return Inertia::render('Portal/AllCategories', [
    ...
    {
        return Inertia::render('Portal/AllExperts', [
            'experts' => Expert::withCount('videos')
                ->orderBy('name')
                ->get(),
        ]);
    }

    public function allTrails()
    {
        return Inertia::render('Portal/AllTrails', [
            'trails' => Trail::withCount('videos')
                ->orderBy('name')
                ->get(),
        ]);
    }
