...
Route::middleware(['auth', 'portal'])->prefix('portal')->name('portal.')->group(function () {
    ...
    Route::get('/categories', [PortalController::class, 'allCategories'])->name('categories');
    Route::get('/experts', [PortalController::class, 'allExperts'])->name('experts');
    Route::get('/trails', [PortalController::class, 'allTrails'])->name('trails');
