...
export const TRILHAS: Trilha[] = [
  { id: 't-1', name: 'Ganhar dinheiro', description: 'Aprenda as bases da riqueza', thumbnail: 'https://picsum.photos/seed/money/800/450' },
  { id: 't-2', name: 'Abrir empresa', description: 'Do zero ao primeiro faturamento', thumbnail: 'https://picsum.photos/seed/business/800/450' },
  { id: 't-3', name: 'Morar no exterior', description: 'Conquiste sua vaga global', thumbnail: 'https://picsum.photos/seed/travel/800/450' },
  { id: 't-4', name: 'Falar Inglês', description: 'Fluência acelerada', thumbnail: 'https://picsum.photos/seed/english/800/450' }
];
...
export const VIDEOS: Video[] = [
  ...
  },
  {
    ...
    description: 'As frases essenciais para você não passar perrengue no aeroporto ou hotel.',
